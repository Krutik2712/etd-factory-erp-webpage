        ...
        <CardContent className="space-y-6">
          ...
          {selectedTank && (
            <>
              ...
              {/* Additional Details - ARMT specific */}
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="ion-weapon-system">Weapon System / Equipment No.</Label>
                  <Input id="ion-weapon-system" placeholder="Enter weapon system or equipment number" />
                </div>
