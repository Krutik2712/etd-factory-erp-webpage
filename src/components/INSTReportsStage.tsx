        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="df-instrument-no">Instrument No.</Label>
                <Input id="df-instrument-no" placeholder="Enter instrument number" />
              </div>
              <div className="space-y-2">
      ...
      {reportType === "vir" && (
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="vir-instrument-no">Instrument No.</Label>
                <Input id="vir-instrument-no" placeholder="Enter instrument number" />
              </div>
              <div className="space-y-2">
