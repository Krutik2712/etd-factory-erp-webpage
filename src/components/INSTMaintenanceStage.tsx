...
export function INSTMaintenanceStage() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>MAINTENANCE STAGE</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-muted/50 rounded-lg">
          <div className="space-y-2">
            ...
            <Input value="INST-MAINT-003" readOnly className="font-medium" />
          </div>
          <div className="space-y-2">
            <Label>Reference ID</Label>
            <Input value="REF-INST-2024-003" readOnly className="font-medium" />
          </div>
          <div className="space-y-2">
            <Label>Date of Issue</Label>
            <Input value="2024-01-17" readOnly className="font-medium" />
          </div>
        </div>
